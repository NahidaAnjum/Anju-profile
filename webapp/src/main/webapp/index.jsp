...
<div class="w3-content" style="max-width:1600px">
  ...
  <header class="w3-container w3-center w3-padding-48 w3-white">
    ...
    <h6>Welcome to the blog of <span class="w3-tag">Anjum's world</span></h6>
  </header>

  <!-- Image header -->
  <header class="w3-display-container w3-wide" id="home">
    <img class="w3-image" src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.elle.com%2Frunway%2Fg28900140%2Fnyfw-spring-2020-collections-inspiration%2F&psig=AOvVaw27FICVd3pDdSqE3_kjzXfE&ust=1675882906789000&source=images&cd=vfe&ved=0CBAQjRxqFwoTCOD17ryMhP0CFQAAAAAdAAAAABAh" alt="Fashion Blog" width="1600" height="1060">
